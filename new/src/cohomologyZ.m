...
Cohomology[charges_,degree_,NN_] := Module[{count1 = CountQ[charges,degree,NN]},
	Which[
		su121Q || su122Q, If[count1 =!= Null,
				{charges . levelvector,charges,degree,NN,count1[[1]],count1[[3]],count1[[1]]-count1[[3]]}//Flatten
			,
				Null
			]
		,
		True, Null (*If[count1 =!= Null && count2 =!= Null,
