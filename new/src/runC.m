...
operatorDirectory = home <> "independentoperator/";
exactDirectory = home <> "exact/";
indExactDirectory = home <> "independentexact/";
indGravitonDirectory = home <> "independentgraviton/";
reducedGravitonDirectory = home <> "reducedgraviton/";
reducedExactDirectory = home <> "reducedexact/";
directories = {home,necklaceDirectory,singleDirectory,multiDirectory,singleGravitonDirectory,multiGravitonDirectory,countDirectory,cohomologyDirectory,juliaDirectory,hDirectory,adDirectory,multiTraceChargeListDirectory,operatorDirectory,exactDirectory,indExactDirectory,indGravitonDirectory,reducedGravitonDirectory,reducedExactDirectory};
